# Judgment: notebook_unexecuted_cells
...
| saved_outputs | EVALUABLE | UNSATISFIED | 0.0/1 | candidate/notebook.ipynb#cell-4,cell-5: Required submitted outputs absent in cell-4, cell-5; counts are supporting only. |
| fresh_outputs | NOT_EVALUABLE | unresolved | None/1 | candidate/notebook.ipynb: No complete submitted/runtime output pair; freshness unresolved. |
| metric | EVALUABLE | UNSATISFIED | 0.0/1 | candidate/notebook.ipynb: No submitted RMSE output after all cell outputs and files inspected. |
...
| artifact | EVALUABLE | UNSATISFIED | 0.0/1 | candidate/residual.svg: Required submitted SVG absent/invalid: residual.svg |
...
Content: None/10.0; known: 5.0; unresolved maximum: 1.0; final: None.
...
## submitted_run
- submitted_run.1: Submit completed output for every nonempty code cell as Run All evidence. — UNSATISFIED; Required submitted outputs absent in cell-4, cell-5; counts are supporting only.
...
## saved_outputs
- saved_outputs.1: Save all nonempty code-cell outputs in the submitted notebook. — UNSATISFIED; Required submitted outputs absent in cell-4, cell-5; counts are supporting only.

Flags: none

## fresh_outputs
- fresh_outputs.1: Saved semantic outputs must match current code and supplied data. — None; No complete submitted/runtime output pair; freshness unresolved.

Flags: none

## metric
- metric.1: Submit the RMSE produced by the evaluation cell. — UNSATISFIED; No submitted RMSE output after all cell outputs and files inspected.
...
## artifact
- artifact.1: Submit residual.svg containing the residual scatter plot. — UNSATISFIED; Required submitted SVG absent/invalid: residual.svg
...
```json
{
  ...
  "requirements": [
    ...
    },
    {
      ...
      "clauses": [
        {
          ...
          "mandatory": true,
          "max_points": 1,
          "score_reason": "No complete submitted/runtime output pair; freshness unresolved.",
          "semantic_decision": null
        }
      ],
      "confidence": "HIGH",
      "dependency_aware_status": null,
      "earned_points": null,
      "evaluability": "NOT_EVALUABLE",
      "evidence": [
        {
          "dataset_strength": null,
          "description": "No complete submitted/runtime output pair; freshness unresolved.",
      ...
      "flags": [],
      "inspection_limitations": [
        "No complete submitted/runtime output pair; freshness unresolved."
      ],
      "mandatory": true,
      "max_points": 1,
    ...
    },
    {
      ...
      "clauses": [
        {
          "absence_proof": {
            ...
            "result": "No submitted RMSE output after all cell outputs and files inspected.",
            "scope": "candidate snapshot"
          },
          "clause_id": "metric.1",
          "earned_points": 0,
          ...
          "mandatory": true,
          "max_points": 1,
          "score_reason": "No submitted RMSE output after all cell outputs and files inspected.",
          "semantic_decision": "UNSATISFIED"
        }
      ],
      "confidence": "HIGH",
      ...
      "evidence": [
        {
          "dataset_strength": null,
          "description": "No submitted RMSE output after all cell outputs and files inspected.",
          "evidence_class": "CONTRADICTORY",
    ...
    },
    {
      ...
      "clauses": [
        {
          "absence_proof": {
            ...
            "result": "Required submitted SVG absent/invalid: residual.svg",
            "scope": "candidate snapshot"
          },
          ...
          "mandatory": true,
          "max_points": 1,
          "score_reason": "Required submitted SVG absent/invalid: residual.svg",
          "semantic_decision": "UNSATISFIED"
        }
      ],
      "confidence": "HIGH",
      ...
      "evidence": [
        {
          "dataset_strength": null,
          "description": "Required submitted SVG absent/invalid: residual.svg",
          "evidence_class": "CONTRADICTORY",
  ...
  "runtime_runs": [
    {
      ...
      "file_delta": [
        {
          "path": "executed.ipynb",
          "provenance": "JUDGE_RUNTIME",
          "sha256_after": "4acdaf03d3ebe0834ec23a2fd06bd6a14c2fb5c32946a0ae5337700075c41d54",
          "sha256_before": null
        },
        {
          "path": "residual.svg",
          "provenance": "JUDGE_RUNTIME",
          "sha256_after": "4cb094ba415c1ed52321ba9c706a844fe2b7e9815d39f2f79a7378b0c04d0cab",
          "sha256_before": null
        },
        {
          "path": "runtime.json",
      ...
      "file_hashes": {
        "runtime_after": {
          "executed.ipynb": "4acdaf03d3ebe0834ec23a2fd06bd6a14c2fb5c32946a0ae5337700075c41d54",
          "notebook.ipynb": "9818b22ab675495daf0d08bc60a3e1936b62209d71638010f3bbdf25171d41b7",
          "residual.svg": "4cb094ba415c1ed52321ba9c706a844fe2b7e9815d39f2f79a7378b0c04d0cab",
  ...
  "scoring": {
    ...
    "unresolved_max_points": 1.0
  },
  "snapshot": {
    "identifier": "fixture-v1",
    "sha256": "9818b22ab675495daf0d08bc60a3e1936b62209d71638010f3bbdf25171d41b7"
  },
  "submission_id": "candidate-1",
  "task_id": "notebook_unexecuted_cells"
}
```
