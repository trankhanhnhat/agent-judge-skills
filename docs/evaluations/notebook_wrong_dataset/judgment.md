# Judgment: notebook_wrong_dataset
...
| dataset | EVALUABLE | UNSATISFIED | 0.0/1 | rubric.json#dataset.sha256; candidate/tiny.csv; candidate/notebook.ipynb#cell-1: Actual loaded tiny.csv bytes differ from trusted task hash. |
...
Content: 9.0/10.0; known: 9.0; unresolved maximum: 0.0; final: 9.0.
...
## dataset
- dataset.1: Train/evaluate using the supplied JudgeTiny v1 CSV bytes identified by trusted SHA-256. — UNSATISFIED; Actual loaded tiny.csv bytes differ from trusted task hash.
...
```json
{
      ...
      "clauses": [
        {
          ...
          "mandatory": true,
          "max_points": 1,
          "score_reason": "Actual loaded tiny.csv bytes differ from trusted task hash.",
      ...
      "evidence": [
        {
          ...
          "description": "Actual loaded tiny.csv bytes differ from trusted task hash.",
      ...
      "file_delta": [
        {
          "path": "executed.ipynb",
          "provenance": "JUDGE_RUNTIME",
          "sha256_after": "4ee47daaa1a0b1566e42715919a1e74b69796691d15349e4d01fae25d2dc4023",
          "sha256_before": null
        },
        {
          "path": "residual.svg",
          "provenance": "MODIFIED_BY_RUNTIME",
          "sha256_after": "285d6f119ef151eb5c67751e683ca3fcaa6586725bd69c3f2b35d7333556ce41",
          "sha256_before": "ef5e4287474b81473f8996b0e7477d14af428855cf59ca2e5facff3472efb949"
        },
        {
          "path": "runtime.json",
          "provenance": "JUDGE_RUNTIME",
          "sha256_after": "a08e71d8127e6352c1358e78b33e5d1cefb00bd6d1f59674f23d40d2b8068728",
          "sha256_before": null
        }
      ],
      "file_hashes": {
        "runtime_after": {
          "executed.ipynb": "4ee47daaa1a0b1566e42715919a1e74b69796691d15349e4d01fae25d2dc4023",
          "notebook.ipynb": "c96f1c0d78275b3e1e2d206fa35a7d27291b8a049cb68144841b6e37b4593463",
          "residual.svg": "285d6f119ef151eb5c67751e683ca3fcaa6586725bd69c3f2b35d7333556ce41",
          "runtime.json": "a08e71d8127e6352c1358e78b33e5d1cefb00bd6d1f59674f23d40d2b8068728",
          "tiny.csv": "9c48cc3fbcb88f4392445efd711f859a689be80e7a30df1d5b1721076f3c595d"
        },
        "source_after": {
          "notebook.ipynb": "c96f1c0d78275b3e1e2d206fa35a7d27291b8a049cb68144841b6e37b4593463",
          "residual.svg": "ef5e4287474b81473f8996b0e7477d14af428855cf59ca2e5facff3472efb949",
          "tiny.csv": "9c48cc3fbcb88f4392445efd711f859a689be80e7a30df1d5b1721076f3c595d"
        },
        "source_before": {
          "notebook.ipynb": "c96f1c0d78275b3e1e2d206fa35a7d27291b8a049cb68144841b6e37b4593463",
  ...
  "snapshot": {
    ...
    "sha256": "c96f1c0d78275b3e1e2d206fa35a7d27291b8a049cb68144841b6e37b4593463"
  },
  "submission_id": "candidate-1",
  "task_id": "notebook_wrong_dataset"
}
```
